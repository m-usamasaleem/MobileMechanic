...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Scratch Cover', v: false}, {k:'Basic Paint', v: false}, {k:'Preferred Paint', v: false}, {k:'Premium Paint', v: false}, {k:'Not Sure', v: false}]);
