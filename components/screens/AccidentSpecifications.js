...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Front Bumper Damage', v: false}, {k:'Rear Bumper Damage', v: false}, {k: 'Doors Damage', v: false}, {k:'Lights Damaged', v: false}, {k:'Other', v: false}]);
