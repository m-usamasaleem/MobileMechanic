...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'External Cleaning', v: false}, {k:'Internal Cleaning', v: false}, {k:'Air-Blown Cleaning', v: false}, {k:'Car Wash', v: false}, {k:'Other', v: false}]);
