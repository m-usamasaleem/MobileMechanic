...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Hot Radiator', v: false}, {k:'Water Leaking', v: false}, {k:'Smoke Rising', v: false}, {k:'Rusty Radiator', v: false}, {k:'Other', v: false}]);
    const [num, setnum] = useState(5);
    const [description, setdescription] = useState(" "); 

    let incomingCart = navigationProps.navigation.getParam('cart');
    let pushToCart = {
        service: 'Radiator Issues', 
