...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Change Tyre', v: false}, {k:'Tyre Pressure Dropping', v: false}, {k:'Tyre Puncture', v: false}, {k:'Add Fancy Rims', v: false}, {k:'Other', v: false}]);
