...
import { ScrollView, CheckBox, View, Text, Dimensions, StyleSheet, TextInput, SafeAreaView, Alert ,TouchableOpacity } from 'react-native'
...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'External Polishing', v: false}, {k:'Internal Polishing', v: false}, {k:'Scratch Cover Polishing', v: false}, {k:'Shining Polish', v: false}, {k:'Other', v: false}]);
