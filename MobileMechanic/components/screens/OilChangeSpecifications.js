...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Conventional Oil', v: false}, {k:'High Mileage Oil', v: false}, {k:'Synthetic-Blend Oil', v: false}, {k:'Full-Synthetic Oil', v: false}, {k:'Other', v: false}]);
