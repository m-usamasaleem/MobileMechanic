...
const BatterySpecifications = (navigationProps) => {
    const [batteryState, setbatteryState] = useState([{k:'Engine Tuning', v: false}, {k:'Steering Wheel Alignment', v: false}, {k:'Turbo Back-Exhaust Tuning', v: false}, {k:'Fan Tuning', v: false}, {k:'Other', v: false}]);
